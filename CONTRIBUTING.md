# Contributing to mtl-metadata-mcp
...
1. Check existing [issues](https://github.com/musictechlab/mtl-metadata-mcp/issues)
   to avoid duplicates
...
Open a [discussion](https://github.com/musictechlab/mtl-metadata-mcp/discussions)
